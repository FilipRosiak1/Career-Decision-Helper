...
class CareerDecisionEngineer implements ActionListener
  {  
   JLabel displayLabel;
   JButton nextButton;
   JButton prevButton;
   ...
   ResourceBundle careerResources;
 
   Environment clips;
   boolean isExecuting = false;
   Thread executionThread;
      
   CareerDecisionEngineer()
     {  
      try
        {
         careerResources = ResourceBundle.getBundle("resources.CareerResources",Locale.getDefault());
        }
      ...
      JFrame jfrm = new JFrame(careerResources.getString("CareerDecision"));  
      ...
      prevButton = new JButton(careerResources.getString("Prev"));
      prevButton.setActionCommand("Prev");
      buttonPanel.add(prevButton);
      prevButton.addActionListener(this);
      
      nextButton = new JButton(careerResources.getString("Next"));
   ...
   private void nextUIState() throws Exception
     {
      ...
      if (fv.getFactSlot("state").toString().equals("final"))
        { 
         ...
         nextButton.setText(careerResources.getString("Restart")); 
         prevButton.setVisible(true);
        }
      else if (fv.getFactSlot("state").toString().equals("initial"))
        {
         nextButton.setActionCommand("Next");
         nextButton.setText(careerResources.getString("Next"));
      ...
      for (int i = 0; i < pv.size(); i++) 
        {
         ...
         if (bv.toString().equals(selected))
            { rButton = new JRadioButton(careerResources.getString(bv.toString()),true); }
         else
            { rButton = new JRadioButton(careerResources.getString(bv.toString()),false); }
      ...
      String theText = careerResources.getString(fv.getFactSlot("display").symbolValue());
   ...
   public static void main(String args[])
     {  
      ...
      SwingUtilities.invokeLater(
        new Runnable() 
          {  
           public void run() { new CareerDecisionEngineer(); }  
          });   
     }  
  }